...
import { toggleTheme, selectTheme } from '../../redux/features/theme';
import {
  CreateIcon,
  ExploreIcon,
  MessagesIcon,
...
const NavBar: React.FC = () => {
  ...
  return (
    <div
      className={`navbar-container ${currentTheme === 'dark' ? 'dark-mode' : ''}`}
      style={{
    ...
    >
      <div className="navbar-wrapper">
        ...
        <div className="nav-menu-wrapper cur-point">
          ...
          <div>
              <label className={`switch ${currentTheme === 'dark' ? 'dark-mode' : ''}`}>
